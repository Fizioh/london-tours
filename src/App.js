    ...
    this.productList = [
      {
        id: 1,
        name: "River Tour",
        description: "River Tour Description",
      ...
      },
      {
        id: 2,
        name: "Bus Tour",
        description: "Bus Tour Description",
        date: new Date(2017,6,28,9,0,0),
        price: 12,
      ...
      {
        id: 3,
        name: "Night in the Shard",
        description: "Night in the Shard Description",
      ...
      {
        id: 4,
        name: "Private capsule in the London Eye",
        description: "Private capsule in the London Eye Description",
      ...
      },
      {
        id: 5,
        name: "Museum Hopper",
        description: "Museum Hopper Description",
      ...
      },
      {
        ...
        description: "London By Night Description",
